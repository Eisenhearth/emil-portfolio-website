  ...
  return (
    <div>
      <div className='grid max-w-screen-xl mx-auto grid-cols-1 md:grid-cols-2 py-10 px-4 md:py-12 gap-10 md:gap-0'>
            <div className='font-Oswald text-3xl md:text-6xl lg:text-[76px] leading-none uppercase col-span-1'>
            ...
            <form className='col-span-1' onSubmit={handleSubmit}>
                <div className='mb-5'>
                    <label htmlFor="fullName" className="block mb-2 text-xl font-medium text-black leading-6 font-Condense uppercase tracking-6">Full Name</label>
                    <input value={name} onChange={(e) => setName(e.target.value)} className='block w-full  bg-[#fffff4] border-solid border-2 h-[50px] border-black text-black p-2 rounded-none' />
                </div>
                <div className='mb-5'>
                    <label htmlFor="Email" className="block mb-2 text-xl font-medium text-black leading-6 font-Condense uppercase tracking-6">Email</label>
                    <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}  className='block w-full bg-[#fffff4] border-solid border-2 h-[50px] border-black text-black p-2 rounded-none' />
                </div>
                <div className='mb-3'>
                    <label htmlFor="message" className="block mb-2 text-xl font-medium text-black leading-6 font-Condense uppercase tracking-6">tELL ME ABOUT YOU AND YOUR PROJECT!</label>
                    <textarea value={message} onChange={(e) => setMessage(e.target.value)} className='block w-full bg-[#fffff4] border-solid border-2 border-black h-44 md:h-64 text-black p-2 rounded-none' />
                </div>
