...
const Navbar = () => {
  ...
  return (
    <div className='sticky w-full top-0 start-0 z-50 bg-[#fffff4]'>
        <nav className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4'>
          <Link href="/">
            <svg className="fill-black object-cover h-6 md:h-8 w-auto ml-1 md:ml-0" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 246.63 77.7">
          ...
          className='flex md:hidden gap-6 mr-1  items-center relative z-10'>
            ...
            >
              ...
              <motion.span variants={{
                closed: {opacity: 1, backgroundColor: "black" },
                open: {opacity: 0}
              }} className='w-6 h-[1.2px] block'></motion.span>
              <motion.span variants={{
                closed: {rotate: 0, backgroundColor: "black" },
